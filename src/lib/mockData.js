...
export const MOCK_CATEGORIES = [
  ...
  { id: 'cat-03', user_id: null, name: 'Belanja',           icon: '🛍️', type: 'expense' },
  ...
  { id: 'cat-13', user_id: null, name: 'Transfer Masuk',    icon: '↗️', type: 'income' },
  { id: 'cat-14', user_id: null, name: 'Lainnya',           icon: '💰', type: 'income' },
]

export const MOCK_TRANSACTIONS = [
  {
    id: 'tx-01', user_id: 'mock-user-001', wallet_id: 'wallet-bank', to_wallet_id: null,
    type: 'income', amount: 8_500_000, admin_fee: 0,
    category: { id: 'cat-10', name: 'Gaji', icon: '💼' },
    note: 'Gaji bulan Juli 2025', date: '2025-07-25',
    wallet: { id: 'wallet-bank', type: 'bank' },
  },
  {
    id: 'tx-02', user_id: 'mock-user-001', wallet_id: 'wallet-bank', to_wallet_id: 'wallet-ew',
    type: 'transfer', amount: 500_000, admin_fee: 2_500,
    category: null, note: 'Top up GoPay', date: '2025-07-26',
    wallet: { id: 'wallet-bank', type: 'bank' },
    to_wallet: { id: 'wallet-ew', type: 'ewallet' },
  },
  {
    id: 'tx-03', user_id: 'mock-user-001', wallet_id: 'wallet-ew', to_wallet_id: null,
    type: 'expense', amount: 85_000, admin_fee: 0,
    category: { id: 'cat-01', name: 'Makanan & Minuman', icon: '🍔' },
    note: 'Makan siang + boba', date: '2025-07-27',
    wallet: { id: 'wallet-ew', type: 'ewallet' },
  },
  {
    id: 'tx-04', user_id: 'mock-user-001', wallet_id: 'wallet-cash', to_wallet_id: null,
    type: 'expense', amount: 15_000, admin_fee: 0,
    category: { id: 'cat-02', name: 'Transport', icon: '🚗' },
    note: 'Parkir motor', date: '2025-07-28',
    wallet: { id: 'wallet-cash', type: 'cash' },
  },
  {
    id: 'tx-05', user_id: 'mock-user-001', wallet_id: 'wallet-ew', to_wallet_id: null,
    type: 'expense', amount: 54_000, admin_fee: 0,
    category: { id: 'cat-02', name: 'Transport', icon: '🚗' },
    note: 'GoRide ke kantor', date: '2025-07-29',
    wallet: { id: 'wallet-ew', type: 'ewallet' },
  },
  {
    id: 'tx-06', user_id: 'mock-user-001', wallet_id: 'wallet-bank', to_wallet_id: 'wallet-cash',
    type: 'transfer', amount: 300_000, admin_fee: 0,
    category: null, note: 'Tarik tunai ATM', date: '2025-07-29',
    wallet: { id: 'wallet-bank', type: 'bank' },
    to_wallet: { id: 'wallet-cash', type: 'cash' },
  },
  {
    id: 'tx-07', user_id: 'mock-user-001', wallet_id: 'wallet-ew', to_wallet_id: null,
    type: 'expense', amount: 54_000, admin_fee: 0,
    category: { id: 'cat-05', name: 'Hiburan', icon: '🎮' },
    note: 'Netflix bulan Juli', date: '2025-07-30',
    wallet: { id: 'wallet-ew', type: 'ewallet' },
  },
  {
    id: 'tx-08', user_id: 'mock-user-001', wallet_id: 'wallet-bank', to_wallet_id: null,
    type: 'expense', amount: 1_200_000, admin_fee: 0,
    category: { id: 'cat-06', name: 'Tagihan', icon: '📋' },
    note: 'Bayar kos bulan Juli', date: '2025-07-30',
    wallet: { id: 'wallet-bank', type: 'bank' },
  },
]
